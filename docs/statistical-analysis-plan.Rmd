...
* 2 different extraction procedures were performed
* One extraction had one type of MS done, and another extraction had two different types of MS done (3 total runs)
* The data were sent back by Oklahoma
...
These data are complicated. There are basically `r 3 * 11 * 3 * 58` data points, with most of the concentration values missing (approximately 2/3). The data are hierarchically clustered within site/time/run/metabolite group. 
...
* concentrations so low that with normal random effects, you can get negative means
