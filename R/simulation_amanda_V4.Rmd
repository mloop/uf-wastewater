...
```{r}
impute_kNN_10<-kNN(list_tramadol_10_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("time_index","location_index"),weights = "auto" )

impute_kNN_20<-kNN(list_tramadol_20_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("time_index","location_index"),weights = "auto" )

impute_kNN_30<-kNN(list_tramadol_30_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("time_index","location_index"),weights = "auto" )

impute_kNN_40<-kNN(list_tramadol_40_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("time_index","location_index"),weights = "auto" )

impute_kNN_50<-kNN(list_tramadol_50_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("time_index","location_index"),weights = "auto" )
```
