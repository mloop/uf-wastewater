...
```{r}
impute_kNN_10<-kNN(list_tramadol_10_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("group_1","group_2","group_3","group_4","group_5"),weights = "auto" )

impute_kNN_20<-kNN(list_tramadol_20_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("group_1","group_2","group_3","group_4","group_5"),weights = "auto" )

impute_kNN_30<-kNN(list_tramadol_30_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("group_1","group_2","group_3","group_4","group_5"),weights = "auto" )

impute_kNN_40<-kNN(list_tramadol_40_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("group_1","group_2","group_3","group_4","group_5"),weights = "auto" )

impute_kNN_50<-kNN(list_tramadol_50_combine[,c(1:3,4,6,8,10,12,14)],dist_var =c("group_1","group_2","group_3","group_4","group_5"),weights = "auto" )
```
