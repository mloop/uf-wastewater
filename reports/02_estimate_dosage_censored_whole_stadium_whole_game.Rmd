...
predicted_consumption %>% 
  ...
  kable(booktabs = TRUE, longtable = TRUE, caption = "Table 1. Median and interquartile range of estimated mass loads (mg) of substances that passed through the entire stadium over the course of the game") %>%
