...
```{r message=FALSE, warning=FALSE, echo=FALSE, fig.cap = "Figure 1: Adundance of metabolites in all samples across all time points."}
...
```{r message=FALSE, warning=FALSE, echo=FALSE, fig.cap = "Figure 2: Adundance of metabolites by location across all time points."}
# Create data
