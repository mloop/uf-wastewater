...
predicted_consumption %>% 
  ...
  select(-group) %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Median and interquartile range of estimated mass load (mg/L) of compounds that passed through given location over previous 30 minutes") %>%
