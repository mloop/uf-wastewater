...
predicted_consumption %>% 
  ...
  select(-group) %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Supplemental Table 4. Median and interquartile range of estimated mass loads (mg) of substances that passed through given location over previous 30 minutes") %>%
