...
predicted_consumption <- read_tsv("../output/02_posterior_predictive_doses.txt") %>%
  ungroup() %>%
...
predicted_consumption %>% 
  ...
  select(-group) %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Table 1. Median and interquartile range of estimated distribution of doses in stadium by metabolite, time, and location.") %>%
