...
means <- conditional_effects(fit_amphetamine, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
```{r, fig.width=7, fig.height=2}
means <- conditional_effects(fit_benzo, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
```{r, fig.width=7, fig.height=2}
means <- conditional_effects(fit_cocaine, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
```{r, fig.width=7, fig.height=2}
means <- conditional_effects(fit_hydrocodone, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
```{r, fig.width=7, fig.height=2}
means <- conditional_effects(fit_norhydrocodone, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
means <- conditional_effects(fit_oxycodone, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
means <- conditional_effects(fit_phentermine, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
means <- conditional_effects(fit_pseudoephedrine, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
...
means <- conditional_effects(fit_tramadol, method = "fitted", re_formula = ~NULL)  # include random effect variances in uncertainty
